...
config=config_1
if config == '1': exec(get('https://github.com/cs2ptu/painelcons/main/source/src/menuTerminal.py').text)
elif config == '2': exec(get('https://github.com/cs2ptu/painelcons/main/source/src/menuTouch.py').text)
